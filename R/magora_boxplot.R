...
#'
#' @param data Input data (\code{\link{phenotypes}} filtered by phenotype, mouse line, and tissue, with mouse lines expanded via \code{\link{expand_mouse_line_factor}}, or \code{\link{gene_expressions}} filtered by gene, mouse line, and tissue).
